    ...
    <header>
        <div class="header_topline">
            <div id="top_background_wrapper" class="default">
                ...
                <div id="main_menu">
                    <ul>
                        <li id="menu_button_main">
                            <a href="/main">
                                <span>Главная</span>
                            </a>
                        </li>
                        <li id="menu_button_custom">
                            <a href="/custom"><span>Заказ</span>
                            </a>
                        </li>
                        <li id="menu_button_services">
                            <a href="services">
                                <span>Услуги</span>
                            </a>
                        </li>
                        <li id="menu_button_information">
                            <a href="information">
                                <span>Информация</span>
                            </a>
                        </li>
                        <li id="menu_button_contacts">
                            <a href="contacts">
                                <span>Контакты</span>
                            </a>
                        </li>
                        <li id="menu_button_careers">
                            <a href="careers">
                                <span>Вакансии</span>
                            </a>
                        </li>
...
<div class="error_wrapper">
    Ошибка 404. </br>
    Страници по указаному адресу не существует.
</div>
</section>
<footer>
